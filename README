sale_subscription_payment_collect
===========

The sale_subscription_payment_collect module of the Tryton application platform.
...
questions on the module bug tracker:
  ...
  https://github.com/tryton-ar/sale_subscription_payment_collect/issues
