#!/usr/bin/env python3
# This file is part of the sale_subscription_payment_collect module for Tryton.
...
setup(name=name,
    version=version,
    description='Tryton module that add paymode to sales subscriptions',
    long_description=read('README'),
    author='tryton-ar',
    url='https://github.com/tryton-ar/sale_subscription_payment_collect',
    download_url=download_url,
    package_dir={'trytond.modules.sale_subscription_payment_collect': '.'},
    packages=[
        'trytond.modules.sale_subscription_payment_collect',
        'trytond.modules.sale_subscription_payment_collect.tests',
        ],
    package_data={
